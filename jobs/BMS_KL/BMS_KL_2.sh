...
python BMS_KL.py --dir ./logs/BMS_KL/$target_testset --target_dataset $target_testset --target_subset_split datasets/split_seed_1/$target_testset\_unlabeled_20.csv --bsize 128 --epochs 1000 --model resnet10
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/BMS_explore/logs/BMS_KL/$target_testset/ ~/scratch/BMS_explore/logs/BMS_KL/